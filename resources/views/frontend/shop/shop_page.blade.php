                                    ...
                                    @foreach($categories as $category)
                                        <div class="accordion-group">
                                            <div class="accordion-heading"><a href="#collapse{{ $category->id }}"
                                                    ...
                                                    @if(session()->get('language') == 'vietnam') {{ $category->category_name_vn }} @else {{ $category->category_name_en }} @endif </a>
                                            </div>
                                            <!-- /.accordion-heading -->
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="{{ url('subcategory/product/'.$subcategory->id.'/'.$subcategory->subcategory_slug_en ) }}">
                                                                    @if(session()->get('language') == 'vietnam') {{ $subcategory->subcategory_name_vn }} @else {{ $subcategory->subcategory_name_en }} @endif</a>
                                                            </li>
                                                ...
                                                <div class="product">
                                                    ...
                                                    <div class="product-info text-left">
                                                        <h3 class="name"><a
                                                                ...
                                                                @if(session()->get('language') == 'vietnam') {{ $product->product_name_vn }} @else {{ $product->product_name_en }} @endif</a>
                                                        </h3>
                                                    ...
                                                    <div class="col col-sm-8 col-lg-8">
                                                        ...
                                                        <!-- /.product-price -->
                                                            <div class="description m-t-10">
                                                                @if(session()->get('language') == 'vietnam') {{ $product->short_description_vn }} @else {{ $product->short_description_en }} @endif</div>
                                                            <div class="cart clearfix animate-effect">
                                                                <div class="action">
                                                                    <ul class="list-unstyled">
                                                                        <li class="add-cart-button btn-group">

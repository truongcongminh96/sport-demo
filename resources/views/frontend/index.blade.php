...
{{--                            <li><a data-transition-type="backSlide" href="#apple" data-toggle="tab">Shoes</a></li>--}}
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        ...
                                                        <div>
                                                            @if($product->discount_price == NULL)
                                                                <div class="tag new"><span>@if(session()->get('language') == 'vietnam') Mới @else New @endif</span></div>
                                                            @else
                                                                <div class="tag hot"><span>@if(session()->get('language') == 'vietnam') {{ round($discount) }}% @else {{ round($discount) }}% @endif</span></div>
                                                            @endif
                                                        </div>
                                                        ...
                                                        <div class="action">
                                                            <ul class="list-unstyled">
                                                                ...
                                                                <li class="lnk wishlist">
                                                                    <a class="add-to-cart" title="Wishlist" data-toggle="tooltip" id="{{ $product->id }}" onclick="addToWishlist(this.id)"> <i class="icon fa fa-heart"></i> </a>
                                                                </li>
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        @if(session()->get('language') == 'vietnam') {{ $skipCategory0->category_name_vn }} @else {{ $skipCategory0->category_name_en }} @endif
                    </h3>
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        @if(session()->get('language') == 'vietnam') {{ $skipCategory1->category_name_vn }} @else {{ $skipCategory1->category_name_en }} @endif
                    </h3>
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        @if(session()->get('language') == 'vietnam') {{ $skipBrand1->brand_name_vn }} @else {{ $skipBrand1->brand_name_en }} @endif
                    </h3>
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">

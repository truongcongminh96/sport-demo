                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-6 already-registered-login">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" name="notes" class="form-control unicase-form-control text-input" id="exampleInputEmail1"
                                    ...
                                    <div class="">
                                        <ul class="nav nav-checkout-progress list-unstyled">
                                            ...
                                            @if (Session::has('coupon'))
                                                <li><a href="#"><strong>Subtotal: </strong>
                                                        {{ $cartTotal }}</a></li>
                                                <hr>
                                                <li><a href="#"><strong>Coupon
                                                            Name: </strong>
                                                        {{ session()->get('coupon')['coupon_name'] }}
                                                        ( {{ session()->get('coupon')['coupon_discount'] }} % )</a>
                                                </li>
                                                <hr>
                                                <li><a href="#"><strong>Coupon
                                                            Discount: </strong>
                                            ...
                                            @else
                                                <li><a href="#"><strong>Subtotal: </strong>
                                                        {{ $cartTotal }}</a></li>
                                                <hr>
                                                <li><a href="#"><strong>Grand Total: </strong>
                                                        {{ $cartTotal }}</a></li>
                                                <hr>
                                            @endif
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(key, value) {
                            $('select[name="ward_id"]').append('<option value="' +
                                value.id + '">' + value.ward_name + '</option>');
                        });
                    },
                });
            } else {

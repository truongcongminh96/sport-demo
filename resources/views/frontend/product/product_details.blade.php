...
@section('content')
@section('title')
    @if(session()->get('language') == 'vietnam') {{ $product->product_name_vn }} Chi tiết sản phẩm @else {{ $product->product_name_en }} Product details @endif
@endsection
    <!-- ===== ======== HEADER : END ============================================== -->
                            ...
                            <div class='col-sm-6 col-md-7 product-info-block'>
                                <div class="product-info">
                                    ...
                                    <div class="description-container m-t-20">
                                        @if(session()->get('language') == 'vietnam') {{ $product->short_description_vn }} @else {{ $product->short_description_en }} @endif
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="description" class="tab-pane in active">
                                        <div class="product-tab">
                                            <p class="text">
                                                @if(session()->get('language') == 'vietnam') {!! $product->long_description_vn !!} @else {!! $product->long_description_en !!} @endif
                                            </p>
                                        </div>
                                    </div><!-- /.tab-pane -->
